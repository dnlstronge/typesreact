const grouptaskcontent = {
   ...
   into the relationship between back-end and front-end, without diving further into serverside applications, basically firebase 
   allowed me to get it up and running very quickly.`
}

export default grouptaskcontent;