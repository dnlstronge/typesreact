  ...
  return (
    <>
      <div className={classes.btncontainer}>
        <button onClick={handlePages} value="one" className={pageoneStyle}>
          1
        </button>
        <button onClick={handlePages} value="two" className={pageTwoStyle}>
          2
        </button>
        <button onClick={handlePages} value="three" className={pageThreeStyle}>
          3
        </button>
      </div>
